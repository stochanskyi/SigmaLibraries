...
class DisposableHandlerTest {
    ...
    fun test() {
        val l = lint()
            .files(kotlin(
                "com.stochanskyi.librariesdemo.presentaiton.feature.activityrecognition.activityupdate.ActivityUpdateViewModel.kt",
                testData
            ))
            .issues(TestIssue)
            .run()
...
val testData = """
    ...
    import com.stochanskyi.librariesdemo.presentaiton.feature.activityrecognition.activityupdate.transformers.ActivityTypeNameTransformer
